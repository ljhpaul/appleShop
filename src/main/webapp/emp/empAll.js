/*console.log("empAll.js import 성공");*/

//이벤트속성에 이벤트가 발생했을 때,  수행할 로직을 넣는다.
//이벤트 핸들러(이스너)-함수
window.onload = function() {
	/*debugger;*/
	var findEmpButton = document.querySelector("#search1");
